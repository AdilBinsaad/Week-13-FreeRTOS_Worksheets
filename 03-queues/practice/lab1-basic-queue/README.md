...
- Task จะ ถูก Blocked (รอจนมีที่ว่าง) หรือ ส่งไม่สำเร็จทันที ถ้า timeout = 0
2. เมื่อ Queue ว่าง การเรียก `xQueueReceive` จะเกิดอะไรขึ้น?
- Task จะ ถูก Blocked (รอจนมีข้อมูล) หรือ รับไม่สำเร็จทันที ถ้า timeout = 0
3. ทำไม LED จึงกะพริบตามการส่งและรับข้อความ?
- เพราะแต่ละครั้งที่มีการส่งหรือรับใน queue จะมีโค้ดควบคุมให้ LED เปลี่ยนสถานะ (ON/OFF) แสดงการทำงานของ task นั่นเอง
